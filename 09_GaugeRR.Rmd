...
colnames(resultsGRR2) <- colnames(resultsGRR)[-4]
...
### Minitab {#minitabGRR}
```{r grrMinitab, echo=FALSE, fig.cap="\\label{fig:grrMinitab}Minitab Output for Type 2 Gauge r&R Analysis taken from Montgomery (2012)"}
knitr::include_graphics('Screenshots/Gauge R&R/grrMinitab.png')
```
...
colnames(resultsGRRType3) <- c("JASP", "By Hand", "JMP", "R")
...
Montgomery, D. C. (2012). *Introduction to statistical quality control* (7th edn). John Wiley & Sons.
